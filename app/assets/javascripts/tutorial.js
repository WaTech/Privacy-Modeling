...
$(document).ready(function () {
    ...
    $('#select_use_items').each(function () {
        ...
        $(this).find('input').change(function () {
            if ($(":checkbox:checked").length > 0) {
                ...
                $('.introjs-prevbutton').css('display', 'inline-block');
                $('body').removeClass('back-btn');
            }
        })
    });

    $('#select_piis').each(function () {
        $(this).find('label').on('click', function () {
            $('.introjs-prevbutton').css('display', 'none');
            $('body').addClass('back-btn');
        });
    ...
    // centered block, if click on bullets
...
function stepTwo() {
    ...
    if ((cookies.indexOf("steptwo=two_step;") + 1) || (cookies.indexOf("skipbutton=skipbutton") + 1)) {
        ...
        setTimeout(function () {
            ...
            document.cookie = "steptwo=two_step;path=/";
            cookies = document.cookie;
